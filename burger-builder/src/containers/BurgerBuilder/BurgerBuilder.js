...
export const BurgerBuilder = (props) => {
  ...
  let burger = props.error ? <p>Ingredients can't be loaded from the server!</p> : <Spinner />;
  ...
  if (props.ings) {
    ...
    orderSummary = (
      <OrderSummary
        ...
        purchaaseCancel={purchaseCancelHandler}
        purchaseAccept={purchaseContinueHandler}
        price={props.price}
      />
    );
  }
